...
1. 要开始使用该资产，请通过 Package Manager 将其导入到您的 Unity 项目中。

2. 现在您需要配置中央脚本，它有两个版本：
...
3. A 和 B 两个版本都使用各自的本地化器类型，这些类型继承自 **LocBase&lt;,&gt;** 类。例如：
...
- **Table Translation:** /75-table-translation/
