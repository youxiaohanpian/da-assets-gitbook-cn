...
1. 要开始创建预制件，请进入 Figma Converter 设置，该设置位于您要转换为其子对象的 Canvas 上。

2. 转到 **"PREFAB CREATOR"** 选项卡。\
   配置预制件创建选项并点击 **"Create Prefabs"** 按钮。

3. 算法运行一段时间后，您将看到控制台消息，指示预制件已**成功创建**。
...
- **SyncHelper 组件:** 相关文档
- **场景备份:** /43-scene-backups/
- **脚本生成器:** /22-script-generator/
